...
def get_post_types(sql_file, output_txt):
    print(f"Buscando post_types no arquivo: {sql_file}")
    ...
    print("Post types encontrados:", post_types)
    with open(output_txt, 'w', encoding='utf-8') as f:
        f.write('\n'.join(post_types))

if __name__ == "__main__":
    get_post_types(r"wordpress\cimaml55_wp821.sql", r"migracao_wp\post_types.txt")
