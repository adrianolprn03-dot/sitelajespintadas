...
const paginasEstaticas: SearchResult[] = [
    ...
    { titulo: "Unidades Escolares e Creches", href: "/unidades-escolares", secao: "Serviços", tipo: "pagina" },
    { titulo: "Unidades de Saúde (UBS / UMS)", href: "/unidades-de-saude", secao: "Serviços", tipo: "pagina" },
    { titulo: "Educação e Escolas", href: "/servicos/educacao", secao: "Serviços", tipo: "pagina" },
    { titulo: "Assistência Social", href: "/servicos/social", secao: "Serviços", tipo: "pagina" },
