...
export default function MedicamentosSUSClient({ medicamentos }: { medicamentos: Medicamento[] }) {
    const [abaAtiva, setAbaAtiva] = useState<"lista" | "como-obter">("lista");
    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 bg-white p-2.5 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/50 max-w-2xl mx-auto">
                <button
                    onClick={() => setAbaAtiva("lista")}
                    className={`flex-1 py-4 px-6 rounded-[1.5rem] font-black text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-3 ${
                        abaAtiva === "lista"
                            ? "bg-[#003366] text-white shadow-lg shadow-blue-900/20 scale-[1.02]"
                            : "text-gray-500 hover:text-gray-900 hover:bg-gray-50"
                    }`}
                >
                    <FaListUl className="text-base" /> Relação de Medicamentos (REMUME)
                </button>
                <button
                ...
                >
                    <FaCircleInfo className="text-base" /> Como Obter Medicamento Básico
                </button>
            </div>
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-gray-100 shadow-xl shadow-gray-200/40 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="flex items-center gap-4 bg-emerald-50/60 p-5 rounded-2xl border border-emerald-100">
                                ...
                                <div>
                                    <span className="text-[10px] font-black uppercase tracking-wider text-emerald-700">Documento Obrigatorio</span>
