...
const modulosAlvo = [
    ...
    { value: "convenios", label: "Card: Convênios" },
    { value: "diarias", label: "Card: Diárias" },
    { value: "servidores", label: "Card: Servidores / Folha" },
    { value: "relatorios", label: "Card: Relatórios Fiscais" },
    { value: "orcamento", label: "Card: LOA / LDO / PPA" },
    { value: "dados-abertos", label: "Card: Dados Abertos" },
    { value: "obras", label: "Card: Obras Públicas" },
    { value: "conselhos", label: "Card: Conselhos Municipais" },
    { value: "passiva", label: "Card: Transparência Passiva" },
    { value: "faq", label: "Card: Perguntas Frequentes" },
    { value: "glossario", label: "Card: Glossário" },
    { value: "legislacao", label: "Card: Legislação Municipal" },
